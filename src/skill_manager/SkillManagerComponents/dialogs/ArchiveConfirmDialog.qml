/**
 * Purpose: A modern confirmation dialog for archiving actions.
 * Usage:
 * ArchiveConfirmDialog {
 *     id: archiveDialog
 *     onAccepted: () => console.log("Archiving confirmed")
 * }
 */
import QtQuick
...
Dialog {
    ...
    property string message: "Are you sure you want to archive this item?"
    ...
    function confirmSingle(title, callback) {
        ...
        root.message = "Are you sure you want to archive this skill?"
    ...
    function confirmBulk(count, callback) {
        ...
        root.message = "Are you sure you want to archive " + count + " selected skills?"
        root.currentCallback = callback
        root.open()
        cancelBtn.forceActiveFocus()
    }
    ...
    contentItem: ColumnLayout {
        ...
        ColumnLayout {
            ...
            Text {
                text: "Archived skills can be restored later."
                font.family: Theme.fontFamily
