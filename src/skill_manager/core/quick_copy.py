...
# Cache to avoid redundant file system stat calls during directory traversal
...
# Cache to avoid repetitive string manipulations and normcase calls in hot paths
@lru_cache(maxsize=2048)
