...
# Cache resilient path resolution to avoid repeated disk checks and string manipulation
...
# Cache pure-Python path normalizations to speed up discovery and file walking
@lru_cache(maxsize=2048)
