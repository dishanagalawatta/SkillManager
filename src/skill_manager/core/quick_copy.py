...
# Cache pure-Python path resolution to avoid redundant FS checks in hot loops
...
# Cache pure-Python path normalization to speed up discovery and file walking
@lru_cache(maxsize=2048)
