...
class SkillIndexer:
    ...
    def build_index_data(self, skill: dict[str, Any]) -> dict[str, Any]:
        ...
        # Pre-compute tokens to avoid O(N) list concatenation during search
...
class SearchEngine:
    ...
    def query(
        ...
        # Optimize fuzz match overhead by caching threshold checks inline
    ...
    def _calculate_score(
        self, query: str, index_data: dict[str, Any]
    ) -> float:
        """
