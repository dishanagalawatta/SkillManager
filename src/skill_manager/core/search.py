...
class SkillIndexer:
    ...
    def build_index_data(self, skill: dict[str, Any]) -> dict[str, Any]:
        ...
        # deduplicate tokens directly during indexing to avoid doing it
        # on every query per document. Precomputing as list prevents
        # dictionary iteration overhead inside the fuzzy match loop
