...
class SkillIndexer:
    ...
    def build_index_data(self, skill: dict[str, Any]) -> dict[str, Any]:
        ...
        # Precompute all document tokens for faster scoring
...
class SearchEngine:
    ...
    def query(
        ...
        # Hoist tokenization out of the document scoring loop
    ...
    def _calculate_score(
        self, query: str, index_data: dict[str, Any], query_tokens: list[str]
    ) -> float:
        """
