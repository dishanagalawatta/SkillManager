...
class SkillIndexer:
    ...
    def build_index_data(self, skill: dict[str, Any]) -> dict[str, Any]:
        ...
        # Pre-compute combined tokens to avoid recreating them dynamically on every query score
...
class SearchEngine:
    ...
    def query(
        ...
        # Tokenize query once here, instead of per document in _calculate_score
    ...
    def _calculate_score(
        ...
        if query_tokens:
            # Use pre-computed all_doc_tokens
