...
class SkillModel(QAbstractListModel):
    ...
    incubatingChanged: ClassVar[Signal]
    ...
    _incubating: bool
    _pending_signals: list[Any]
    _incubation_timer: Any
    ...
    @Slot(result=list)
    def getSelectedNames(self) -> list[str]: ...
    @Slot(result=list)
    ...
    def _queue_signal(self, signal_emitter: Any) -> None: ...
    def _replay_pending_signals(self) -> None: ...
    def _force_end_incubation(self) -> None: ...
    def _emit_data_changed_for_path(self, path: str) -> None: ...
    ...
    @Slot(str, result=int)
    def firstVisibleRowForCategory(self, name: str) -> int: ...
    @Slot(str, result=int)
    def visibleRowCountForCategory(self, name: str) -> int: ...
