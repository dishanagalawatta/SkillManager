...
### 3. Release Triggers (Opt-in Strategy)

Detail the explicit release triggers used by the project:
...
*If no trigger word is present, the commit will be merged without triggering a new version or release.*
```
