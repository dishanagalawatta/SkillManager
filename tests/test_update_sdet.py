...
class TestUpdateControllerSDET:
    ...
    def test_add_skill_package_strict_schema(self, controller, mock_app):
        ...
        with patch("skill_manager.core.skill_packages.check_skill_package_versions", side_effect=lambda x: x):
    ...
    def test_resolve_package_storage_state_recovery(self, controller, mock_app):
        ...
        with patch("skill_manager.core.skill_packages.resolve_package_storage", side_effect=lambda p, i: p):
    ...
    def test_scan_for_updates_silent_auto_trigger(self, mock_service_class, controller, mock_app):
        ...
        with patch("skill_manager.controllers.update_controller.QTimer.singleShot", side_effect=lambda ms, obj, cb: cb()), \
