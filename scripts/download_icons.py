...
mappings = {
    ...
    "solar:alt-arrow-down-bold-duotone":   ["expand-arrow-icon.svg", "expand-arrow-icon-dark.svg",
                                            "expand-arrow-icon-light.svg", "collapse-arrow-icon.svg",
                                            "collapse-arrow-icon-dark.svg", "collapse-arrow-icon-light.svg"],
    ...
    "solar:close-circle-broken":           ["close-icon.svg"],
