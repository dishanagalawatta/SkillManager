...
class DiscoveryService:
    """Find, parse, and normalize skills and commands across sources and projects."""
    def discover_all(self, force_full_scan: bool = False) -> dict[str, Any]: ...
    def discover_single(self, path: Path, project_path: Path, is_package: bool | None = None) -> dict[str, Any] | None: ...
    def discover_project(self, project_path: Path) -> list[dict[str, Any]]: ...
    def transform_skill(self, skill: dict[str, Any], is_package: bool, project_label: str | None = None) -> dict[str, Any]: ...
```
